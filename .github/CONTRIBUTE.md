...
```bash
$ git clone git@github.com:finalgene/docker-hub-hadolint.git
```

- Or via HTTPS:

```bash
$ git clone https://github.com/finalgene/docker-hub-hadolint.git
```
...
2. Fork the repository (http://github.com/finalgene/docker-hub-hadolint)
3. Clone the canonical repository locally and enter it.

```bash
$ git clone git://github.com/finalgene/docker-hub-hadolint.git
$ cd docker-hub-hadolint
```

4. Add a remote to your fork; substitute your GitHub username in the command below.

```bash
$ git remote add {username} git@github.com:{username}/docker-hub-hadolint.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/docker-hub-hadolint.git
